...
REQUIRED_FIXED_FILES = {
    ...
    "requirements/linux-x64-py312/runtime.txt",
    "requirements/linux-x64-py312/dev.txt",
    "requirements/linux-x64-py313/runtime.txt",
    "requirements/linux-x64-py313/dev.txt",
